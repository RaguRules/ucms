...
if (isset($_POST["btn_update"])) {
    ...
    try {
        $stmtUpdate = $conn->prepare("UPDATE staff SET first_name=?, last_name=?, mobile=?, nic_number=?, date_of_birth=?, email=?, address=?, court_id=?, role_id=?, image_path=?, gender=?, appointment=? WHERE staff_id=?");
	...
	<body class="light-mode">
		...
		<?php
			...
			// <!-- FULL VIEW SECTION -->
					...
					$row = getStaffDataFromDatabase(sanitize_input($staff), $conn);
				?>
