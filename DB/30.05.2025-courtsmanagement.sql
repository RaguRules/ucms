...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 30, 2025 at 10:49 AM
...
('C0001', '110111', 'CID', 'SUREN', 'ARJUNA', 'SARNIYA', '2025-05-13', 1, 'Criminal', 'Trial', 1, '2025-12-31', 'Trial', 'L0005', 'Magistrate&#039;s co'),
('C0002', 'D/934/15', 'RAJAN', 'KEETHA', 'SARNIYA', 'BANUSHA', '2025-05-13', 1, 'Civil', 'Calling', 0, '2025-08-29', 'Calling', 'L0005', 'District Court'),
('C9997', 'L/420/23', 'AMALA', 'COOLMAN', 'BUGCYF', 'JGHGC', '2025-05-13', 1, 'Civil', 'Calling', 0, '2025-12-31', 'Pre Trial Conference', 'L0005', 'District Court'),
...
CREATE TABLE IF NOT EXISTS `dailycaseactivities` (
  ...
  `next_date` date DEFAULT NULL,
  `current_status` enum('Calling','Pre Trial Conference','Trial','Inquiry','Order','Judgement','Post Judgement Calling','Laid By','Appeal','Completed/ Closed') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `next_status` enum('Calling','Pre Trial Conference','Trial','Inquiry','Order','Judgement','Post Judgement Calling','Completed/ Closed') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
('A0002', 'C0002', 'for replication and support', '2025-07-12', 'Trial', 'Post Judgement Calling', 1, '2025-05-13', 'L0005'),
('A0003', 'C0002', 'for replication...', '2025-07-14', 'Laid By', 'Pre Trial Conference', 1, '2025-06-14', 'L0005'),
('A0004', 'C0001', 'for replication and support', '2025-07-26', 'Appeal', 'Completed/ Closed', 0, '2023-12-31', 'L0005');
...
('ragu@ragu.com', '$2y$10$hTp3JGS8QTbFj26VrevO8OGr0u4H7a9Vh5.E9douecqCFCJn5pcoO', 0, 423587, 'active', 'R06'),
...
('sriraguraj@yahoo.com', '$2y$10$8Zd8.DTnkuEEs2cQa6lczuf2AB9qqxtG2TF7z.Rh6ZAAnMT2tc7/u', 3, 0, 'active', 'R06'),
