...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 13, 2025 at 03:03 AM
...
INSERT INTO `lawyer` (`lawyer_id`, `first_name`, `last_name`, `mobile`, `email`, `address`, `nic_number`, `date_of_birth`, `enrolment_number`, `joined_date`, `is_active`, `role_id`, `court_name`, `image_path`) VALUES
('L0001', 'ojihougyftdrt', 'ojihugyftd', 98765, '8jbnm@gfcd.com', 'HUGYFT', '987654', '2025-04-15', 'iytrt8', '2025-04-30', 0, 'R06', 'ALL', NULL);
...
('9876@df.com', '$2y$10$t4T1WJXSMFpolvKZDJpG5efsuglQRGvv2nH3qtQGKNo7d1S7uk4L6', 0, 1329, 'Pending', 'LAWYER'),
('a@a.a', '$2y$10$WS8G0fmAlRxCRRrLhgixSeIPV48B3c/FvI3l7ZyGIh3ZwZ4.9k7cG', 0, 1329, 'Pending', 'LAWYER');
...
CREATE TABLE IF NOT EXISTS `police` (
  ...
  `is_active` tinyint(1) DEFAULT '1',
  `role_id` varchar(3) DEFAULT NULL,
  `court_name` varchar(20) DEFAULT 'Magistrate''s Court',
  `image_path` varchar(255) DEFAULT NULL,
...
INSERT INTO `registration` (`reg_id`, `first_name`, `last_name`, `mobile`, `email`, `password`, `address`, `nic_number`, `date_of_birth`, `badge_number`, `court_name`, `enrolment_number`, `role_id`, `joined_date`, `status`, `image_path`) VALUES
('R0002', 'Nive', 'Kannapiran', 97865, '9876@df.com', '$2y$10$t4T1WJXSMFpolvKZDJpG5efsuglQRGvv2nH3qtQGKNo7d1S7uk4L6', 'ugify', '978976', '2025-04-09', 'NULL', 'ALL', '87tyfv', 'R06', '2025-05-01', 'Pending', 'uploads/img_67fb274f42b211.80184803.png'),
('R0001', 'Ra', 'AAL', 978675, 'a@a.a', '$2y$10$WS8G0fmAlRxCRRrLhgixSeIPV48B3c/FvI3l7ZyGIh3ZwZ4.9k7cG', 'gyigiy', '0897867', '2025-04-30', 'NULL', 'ALL', 'ugiug78', 'R06', '2025-04-30', 'Pending', 'uploads/img_67fb24534546e0.73585887.png');
