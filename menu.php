		...
		<div class="container position-relative d-flex align-items-center justify-content-between">
			...
			<nav id="navmenu" class="navmenu navmenu me-4">
				<ul>
					...
					<!-- LEGAL DECISION -->
					<li class="dropdown">
						<a href="#"><span>Legal Decision</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
						<ul>
			...
			<div class="d-flex align-items-center gap-3">
				...
				<div class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="userDropdown">
						...
						<li><a class="dropdown-item" href="index.php?pg=profile.php"><i class="bi bi-person-circle me-2"></i>My Profile</a></li>
